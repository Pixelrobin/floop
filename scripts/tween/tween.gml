...
/// @param ease      Easing equation to use
/// @param start     Starting value
/// @param end       Ending value
/// @param time      Current time
/// @param duration  Duration of ease
/// @param opt1      Extra argument
/// @param opt2      Extra argument
...
switch argument[0] {
	...
	case eases.elastic_in:
		...
		if argument_count < 7 then p = argument[4] * 0.3;
		else p = argument[6];
	...
	case eases.bounce_in:
		return change - tween(eases.bounce_out, 0, change, argument[4] - argument[3], argument[4]) + argument[1];
	...
	case eases.bounce_inout:
		if argument[3] < argument[4] / 2 return tween(eases.bounce_in, 0, change, argument[3] * 2, argument[4]) / 2 + argument[1];
		else return (tween(eases.bounce_out, 0, change, argument[3] * 2 - argument[4], argument[4]) + change) / 2 + argument[1];
}